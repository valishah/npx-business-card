...
const data = {
  ...
  github: chalk.gray('https://github.com/') + chalk.green('valishah'),
  linkedin: chalk.gray('https://linkedin.com/in/') + chalk.blue('valishah'),
  // web: chalk.cyan('https://bnb.im'),
  npx: chalk.red('npx') + ' ' + chalk.white('valishah'),
